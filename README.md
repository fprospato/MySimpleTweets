...
* [x] Go to full profile view setup with users: fullname, username, bio, date joined, number of followers, number of following, profile image, background image, etc
* [x] Get to full profile view in timeline or tweet details by tapping on a profile image, username, or fullname
* [x] reply and like a tweet in both the timeline and tweet detail view
